...
class MyFirstTest(unittest.TestCase):
    ...
    def test_start_game_exit(self):
        try:
            ...
            # Ожидание появления таблицы счета
            score_table = self.driver.wait_for_object(By.NAME, "ScoreLabel", timeout=20)
            ...
            score_table = self.driver.wait_for_object(By.NAME, "ScoreLabel", timeout=200)
            self.assertIsNotNone(score_table)
            ...
            self.driver.load_scene('Menu')
            exit_button = self.driver.find_object(By.NAME, "SurvivalButton")
